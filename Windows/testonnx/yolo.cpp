...
Yolo::Yolo()
{
    Net_config yolo_nets = { 0.5, 0.6, 0.5 ,"D:/Qt/code/code7.7/testonnx/onnxmodels/v5lite-c.onnx", "D:/Qt/code/code7.7/testonnx/sample/coco.names" };
...
std::vector<BoxInfo> Yolo::detect(cv::Mat &frame)
{
    ...
    std::cout << "infer time: " << elapsed_secs*1000 << "ms" << std::endl;
...
void Yolo::inityolo(Net_config config)
{
    // 初始化阈值
