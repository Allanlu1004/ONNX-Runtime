...
Q_DECLARE_METATYPE(BoxInfo_v5lite)


class Yolo
{
public:
    Yolo(Net_config_v5lite yolo_nets);
    std::vector<BoxInfo_v5lite> detect_v5lite(cv::Mat& frame);
    void inityolo(Net_config_v5lite config);
...
private:
    ...
    void nms(std::vector<BoxInfo_v5lite>& input_boxes);
